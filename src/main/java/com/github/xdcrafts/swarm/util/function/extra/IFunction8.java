 ...
 * @param <B> return type
 */
public interface IFunction8<A1, A2, A3, A4, A5, A6, A7, A8, B> {
    /**
     * Applies function.
     ...
     */
    B apply(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8);
    /**
     * Carries function.
     * @param a1 first argument
     * @return carried function
     */
    default IFunction7<A2, A3, A4, A5, A6, A7, A8, B> carry(A1 a1) {
