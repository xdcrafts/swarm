...
import static com.github.xdcrafts.swarm.transducers.Transducers.transduce;
...
public class TransducersTest {
    ...
    public void testMap() throws Exception {
        final ITransducer<String, Long> stringify = Implementations.map(Object::toString);
        final Reduction<List<String>> reduction =
            Transducers.transduce(stringify, addReducer(String.class), new ArrayList<>(), longs(10));
    ...
    public void testFilter() throws Exception {
        final ITransducer<Integer, Integer> odds = Implementations.filter(integer -> integer % 2 != 0);
        final Reduction<List<Integer>> reduction = Transducers.transduce(
    ...
    public void testCat() throws Exception {
        final ITransducer<Integer, Iterable<Integer>> transducer = Implementations.cat();
    ...
    public void testMapcat() throws Exception {
        final ITransducer<Character, Integer> transducer = Implementations.mapcat(integer -> {
        ...
        final Reduction<List<Character>> reduction = Transducers.transduce(
    ...
    public void testComp() throws Exception {
        final ITransducer<Integer, Integer> filter = Implementations.filter(integer -> integer % 2 != 0);
        final ITransducer<String, Integer> map = Implementations.map(Object::toString);
        final ITransducer<String, Integer> transducer = filter.compose(map);
        final Reduction<List<String>> reduction
            = Transducers.transduce(transducer, addReducer(String.class), new ArrayList<>(), ints(10));
        assertFalse(reduction.isFailed());
        assertTrue(reduction.isReduced());
    ...
    public void testTake() throws Exception {
        final ITransducer<Integer, Integer> transducer = Implementations.take(5);
        final Reduction<List<Integer>> reduction = Transducers.transduce(
    ...
    public void testTakeWhile() throws Exception {
        final ITransducer<Integer, Integer> transducer = Implementations.takeWhile(integer -> integer < 5);
        final Reduction<List<Integer>> reduction = Transducers.transduce(
                transducer, addReducer(Integer.class), new ArrayList<>(), ints(20));
        assertFalse(reduction.isFailed());
        assertTrue(reduction.isReduced());
    ...
    public void testDrop() throws Exception {
        final ITransducer<Integer, Integer> transducer = Implementations.drop(5);
        final Reduction<List<Integer>> reduction = Transducers.transduce(
    ...
    public void testDropWhile() throws Exception {
        final ITransducer<Integer, Integer> transducer = Implementations.dropWhile(integer -> integer < 15);
        final Reduction<List<Integer>> reduction = Transducers.transduce(
                transducer, addReducer(Integer.class), new ArrayList<>(), ints(20)
        );
        assertFalse(reduction.isFailed());
    ...
    public void testTakeNth() throws Exception {
        final ITransducer<Integer, Integer> transducer = Implementations.takeNth(2);
        final Reduction<List<Integer>> reduction = Transducers.transduce(
                transducer, addReducer(Integer.class), new ArrayList<>(), ints(10)
        );
        assertFalse(reduction.isFailed());
    ...
    public void testReplace() throws Exception {
        final ITransducer<Integer, Integer> transducer = Implementations.replace(new HashMap<Integer, Integer>() {{
            put(3, 42);
        }});
        final Reduction<List<Integer>> reduction = Transducers.transduce(
    ...
    public void testKeep() throws Exception {
        final ITransducer<Integer, Integer> transducer = Implementations.keep(integer ->
    ...
    public void testKeepIndexed() throws Exception {
        final ITransducer<Integer, Integer> transducer = Implementations.keepIndexed((idx, integer) ->
    ...
    public void testDedupe() throws Exception {
        ...
        final ITransducer<Integer, Integer> transducer = Implementations.dedupe();
        final Reduction<List<Integer>> reduction = Transducers.transduce(
    ...
    public void testPartitionBy() throws Exception {
        ...
        final ITransducer<Iterable<Integer>, Integer> transducer = Implementations.partitionBy(Function.identity());
        final Reduction<List<List<Integer>>> reduction = Transducers.transduce(
                transducer,
    ...
    public void testPartitionAll() throws Exception {
        final ITransducer<Iterable<Integer>, Integer> transducer = Implementations.partitionAll(3);
        final Reduction<List<List<Integer>>> reduction = Transducers.transduce(
                transducer,
                (List<List<Integer>> result, Iterable<Integer> input) -> {
                    final List<Integer> ret = new ArrayList<>();
